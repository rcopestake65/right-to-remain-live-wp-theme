    ...
    <div class="container overview">
        ...
        <div class="nav-item-container">
            ...
            <a href="/statement-of-evidence-form">
                <div class="nav-item nav-item-4" style="background-color:<?php echo $evidence; ?>">Satement of
                    Evidence
                    Form</div>
            </a>
            ...
            <a href="/home-office-positive-decision">
                <div class="nav-item nav-item-6" style="background-color:<?php echo $positive_decision; ?>">Home
                    Office
                    positive
                    decision</div>
            </a>
            <a href="/home-officere-refusal">
                <div class="nav-item nav-item-7" style="background-color:<?php echo $refusal; ?>">Home Office
                    refusal
                </div>
            </a>
            <a href="/submit-appeal">
                <div class="nav-item nav-item-8" style="background-color:<?php echo $submit_appeal; ?>">Submit
                    appeal
                </div>
            </a>
            <a href="/appeal-hearing">
                <div class="nav-item nav-item-9" style="background-color:<?php echo $appeal_hearing; ?>">Appeal
                    hearing
                </div>
            </a>
            <a href="/possible-outcomes-after-appeal-hearing">
                <div class="nav-item nav-item-10" style="background-color:<?php echo $possible_outcomes; ?>">
                    Outcomes
                    after
                    appeal hearing</div>
            </a>
            <a href="/fresh-claim">
                <div class="nav-item nav-item-11" style="background-color:<?php echo $fresh_claim; ?>">Fresh claim
                </div>
            </a>
            <a href="/possible-outcomes-from-a-fresh-claim">
                <div class="nav-item nav-item-12" style="background-color:<?php echo $fresh_outcomes; ?>">Outcomes
                    from
                    a fresh claim</div>
            </a>
        </div>
