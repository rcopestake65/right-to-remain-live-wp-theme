...
gsap.to(".home img:nth-of-type(2)", {
  duration: 2,
  x: 0,
  y: 0,
  opacity: 1,
...
if (stages) {
  ...
  gsap.set(
    ...
    { opacity: 0, scaleX: 0, scaleY: 0, display: "none" }
  );

  //card-full 1 show
  var tlcardFull1 = new gsap.timeline({ paused: true });
  tlcardFull1.to(".card-full-1", {
    scaleX: 1,
    scaleY: 1,
    transformOrigin: "center center",
    opacity: 1,
  ...
  //card-full 11 show
  var tlcardFull11 = new gsap.timeline({ paused: true });
  tlcardFull11.to(".card-full-11", {
    scaleX: 1,
    scaleY: 1,
    transformOrigin: "center center",
    opacity: 1,
  ...
  $(".read-more-btn-11").on("click", function () {
    tlcardFull11.play();
  });

  $(".card-full-close-btn-11").on("click", function () {
  ...
  //card-full 12 show
  var tlcardFull12 = new gsap.timeline({ paused: true });
  tlcardFull12.to(".card-full-12", {
    scaleX: 1,
    scaleY: 1,
    transformOrigin: "center center",
    opacity: 1,
  ...
  $(".read-more-btn-12").on("click", function () {
    tlcardFull12.play();
  });

  $(".card-full-close-btn-12").on("click", function () {
  ...
  //card-full 13 show
  var tlcardFull13 = new gsap.timeline({ paused: true });
  tlcardFull13.to(".card-full-13", {
    scaleX: 1,
    scaleY: 1,
    transformOrigin: "center center",
    opacity: 1,
  ...
  $(".read-more-btn-13").on("click", function () {
    tlcardFull13.play();
  });

  $(".card-full-close-btn-13").on("click", function () {
  ...
  //card-full 14 show
  var tlcardFull14 = new gsap.timeline({ paused: true });
  tlcardFull14.to(".card-full-14", {
    scaleX: 1,
    scaleY: 1,
    transformOrigin: "center center",
    opacity: 1,
  ...
  $(".read-more-btn-14").on("click", function () {
    tlcardFull14.play();
  });

  $(".card-full-close-btn-14").on("click", function () {
  ...
  //card-full 15 show
  var tlcardFull15 = new gsap.timeline({ paused: true });
  tlcardFull15.to(".card-full-15", {
    scaleX: 1,
    scaleY: 1,
    transformOrigin: "center center",
    opacity: 1,
  ...
  $(".read-more-btn-15").on("click", function () {
    tlcardFull15.play();
  });

  $(".card-full-close-btn-15").on("click", function () {
  ...
  //card-full 16 show
  var tlcardFull16 = new gsap.timeline({ paused: true });
  tlcardFull16.to(".card-full-16", {
    scaleX: 1,
    scaleY: 1,
    transformOrigin: "center center",
    opacity: 1,
  ...
  $(".read-more-btn-16").on("click", function () {
    tlcardFull16.play();
  });

  $(".card-full-close-btn-16").on("click", function () {
